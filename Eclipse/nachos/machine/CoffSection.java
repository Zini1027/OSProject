...
public class CoffSection {
    ...
    /**
     * Test whether this section is initialized. Loading a page from an initialized section requires
     * a disk access, while loading a page from an uninitialized section requires only zero-filling
     * the page.
     *
    ...
    public void loadPage(int spn, int ppn) {
        ...
        if (!initialized)
            ...
            /**
             * initlen = size % pageSize; Bug identified by Steven Schlansker 3/20/08 Bug fix by
             * Michael Rauser
             */
